function medicineMain(){
  setYesterdayDate(); //Functions.gs
  getMedicineCountMetrics(); //Medicine.gs
  medicineUpdateDataToSheet(); //Medicine.gs
}
...
function medicineUpdateDataToSheet() {
  cellWillStartFrom = 10;
  ...
  if (rows) {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      cellNo = getCellNoForMedicine(cols[2].v);
